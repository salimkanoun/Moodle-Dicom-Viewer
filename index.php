...
$event = \mod_dicomviewer\event\course_module_instance_list_viewed::create(array(
    'context' => $modulecontext
));
$event->add_record_snapshot('course', $course);
$event->trigger();

$PAGE->set_url('/mod/dicomviewer/index.php', array('id' => $id));
...
$modulenameplural = get_string('modulenameplural', 'mod_dicomviewer');
...
foreach ($dicomviewers as $dicomviewer) {
    if (!$dicomviewer->visible) {
        $link = html_writer::link(
            new moodle_url('/mod/dicomviewer/view.php', array('id' => $dicomviewer->coursemodule)),
